...
The system SHALL parse markdown text and render it with visual formatting for headings (h1-h6), bold, italic, inline code, code blocks, unordered lists, ordered lists, links, and images.
...
- **THEN** each element is displayed with distinct visual formatting that differentiates it from plain text
